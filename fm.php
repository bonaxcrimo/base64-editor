...
$auth_users = array(
    'admin' => 'admin', //admin@123 $2y$10$gahUCu2js.vOC.FSaoOTuem9Ytj3DBXmaL5WZzqRtkNeP67vvdHiC
    'user' => '12345' //12345$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO
);
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        // if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && ($_POST['fm_pwd'] ==  $auth_users[$_POST['fm_usr']])) {
...
defined('FM_FILE_EXTENSION') || define('FM_FILE_EXTENSION', $allowed_file_extension);
...
//--- FILEMANAGER MAIN
fm_show_header(); // HEADER
$show_header==true?fm_show_nav_path(FM_PATH):""; // current path
...
<form action="" method="post">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm bg-white" id="main-table">
            ...
            <tr>
                <?php if (!FM_READONLY): ?>
                    <th style="width:3%;display: none" class="custom-checkbox-header">
            ...
            if ($parent !== false) {
                ...
                <tr><?php if (!FM_READONLY): ?>
                    <td class="nosort" style="display: none"></td><?php endif; ?>
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    <?php if (!FM_READONLY): ?>
                        <td class="custom-checkbox-td" style="display: none">
                        <div class="custom-control custom-checkbox">
                    ...
                    <?php endif; ?>
                    <td class="inline-actions" style="display: none"><?php if (!FM_READONLY): ?>
            ...
            foreach ($files as $f) {
                ...
                //bona
                $fullPath=FM_ROOT_PATH."/".fm_clean_path(FM_PATH)."/".urlencode($f);
                ?>
                <tr>
                    <?php if (!FM_READONLY): ?>
                        <td class="custom-checkbox-td" style="display: none">
                    ...
                    <td>
                        <!-- href old = <?php echo $filelink ?> -->
                        <div class="filename"><a class="data-link-full" data-link="<?=  $fullPath ?>" href="#" title="File info"><i class="<?php echo $img ?>"></i> <?php echo fm_convert_win($f) ?>
                            </a><?php echo($is_link ? ' &rarr; <i>' . readlink($path . '/' . $f) . '</i>' : '') ?></div>
                    </td>
                    ...
                    <?php endif; ?>
                    <td class="inline-actions" style="display: none">
                        <?php if (!FM_READONLY): ?>
...
function fm_show_nav_path($path)
{
    ...
    ?>
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 main-nav <?php echo $isStickyNavBar ?>" style="display:none">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            echo '<div class="col-xs-6 col-sm-5" id="me">' . $root_url . '</div>';
            ?>
...
global $lang, $root_url, $sticky_navbar,$show_header;
$isStickyNavBar = $sticky_navbar ? 'navbar-fixed' : 'navbar-normal';
$isStickyNavBar = $show_header==true?$isStickyNavBar:"navbar-normal";
?>
<!DOCTYPE html>
<html>
<head>
...
<?php
            ...
            if ($path != '') {
                ...
                for ($i = 0; $i < $count; $i++) {
                    $parent = trim($parent . '/' . $exploded[$i], '/');
                    $parent_enc = urlencode($parent);
                    $array[] = "<li class='breadcrumb-item'><a href='?p={$parent_enc}'>" . fm_enc(fm_convert_win($exploded[$i])) . "</li>";
                }
                $root_url .= $sep . implode($sep, $array);
            }
            // echo '<div class="col-xs-6 col-sm-5" id="me">' . $root_url . '</div>';
...
<?php endif; ?>
<script>
    // $(".data-link-full").each(function(idx,elm){
    //     $(elm).click(function(){
    //         console.log("ckucke");
    //     });
    // });
